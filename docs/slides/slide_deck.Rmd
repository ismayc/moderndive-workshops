...
## Albert's Course (Introduction to Statistical & Data Sciences)
...
* Many new tools, like DataCamp, allow us to outsource needed practice with instant feedback.
...
library(forcats)
library(fivethirtyeight)
ggplot(data = bechdel, mapping = aes(x = clean_test %>% fct_infreq %>% fct_rev)) +
  geom_bar()
```
...
Sampling is at the root of statistics. Two approaches to understanding:
...
<center><img src="figure/lady_tasting_tea.jpg" alt="Drawing" style="height: 500px;"/></center>
